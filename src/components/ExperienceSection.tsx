...
const experiences = [
  {
    ...
    description:
      "Location: Kota Jakarta Selatan, Kec. Kby. Baru. Grand Wijaya Centre.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Location: Kota Tasikmalaya. Collaborated with lecturers on research regarding 'Classification of Tasikmalaya batik motifs using convolutional neural networks'. Conducted observations, collected dataset, assisted in testing models, and participated in research seminar.",
  },
  {
    id: 4,
    company: "Universitas Perjuangan Tasikmalaya",
    ...
    description:
      "Location: Kota Tasikmalaya. Collaborated on research regarding 'The Implementation of CNN Algorithms in Recognition Applications (Aksara Sunda)'. Collected datasets, implemented MobileNet for CNN, built system for model implementation, and tested with students at SMP N 5 Kota Tasikmalaya.",
  },
  {
    id: 5,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8 h-fit lg:sticky lg:top-32">
            ...
            <h2 className="experience-title opacity-0 font-outfit font-light text-4xl md:text-5xl text-[var(--text-primary)] leading-[1.1] tracking-tight">
              Karier &{" "}
              <span className="font-ganky text-[var(--accent-primary)] block mt-2">
                Pengalaman.
              </span>
            </h2>
            <p className="experience-title opacity-0 text-[var(--text-secondary)] font-light mt-4 mb-8">
              Jejak perjalanan profesional saya dalam membangun solusi digital.
              (Silakan sesuaikan data ini dengan profil LinkedIn Anda)
            </p>
          </div>
          ...
          <div className="lg:col-span-8 lg:pl-12">
            <div
              ref={timelineRef}
              className="relative border-l border-[var(--border-color)] ml-4 md:ml-0"
            >
