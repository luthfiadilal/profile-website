...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="py-32 bg-[var(--bg-primary)] relative transition-colors duration-500 overflow-hidden"
    >
          ...
          <div className="contact-info-container lg:col-span-5 space-y-4">
            {contactInfo.map((item) => (
              ...
              >
                ...
                <div>
                  <p className="text-xs text-[var(--text-secondary)] opacity-70 font-medium uppercase tracking-widest mb-1.5">
                    {item.label}
                  </p>
                  <p className="text-sm text-[var(--text-primary)] transition-colors tracking-wide">
                    {item.value}
                  </p>
                </div>
              </a>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-xs font-medium uppercase tracking-widest text-[var(--text-secondary)] mb-2"
                >
                  Your Name
                </label>
                <input
