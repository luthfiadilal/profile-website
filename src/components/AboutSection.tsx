          ...
          <div className="lg:col-span-8 about-text-container">
            ...
            <div className="flex flex-col gap-6 text-[var(--text-secondary)] text-lg font-light leading-relaxed mb-12">
              <p className="about-text opacity-0">
                ...
                Perjuangan Tasikmalaya yang bersemangat dalam membangun aplikasi
                web dan mobile. Saya fokus pada pengembangan full-stack dengan
                teknologi modern.
              </p>
              <p className="about-text opacity-0">
                Berbasis di Tasikmalaya, Jawa Barat, saya aktif mengerjakan
                berbagai proyek mulai dari aplikasi berbasis AI, sistem
                manajemen, hingga aplikasi mobile Flutter. Saya selalu
                bersemangat mempelajari teknologi baru.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-12 mb-12 border-y border-[var(--border-color)] py-8">
              {stats.map((s) => (
                <div
                  key={s.label}
                  className="about-stat opacity-0 flex flex-col gap-2"
                >
                  <p className="text-4xl md:text-5xl font-light text-[var(--text-primary)] tracking-tighter">
                    {s.value}
                  </p>
